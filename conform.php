...
?>
            ...
            <div class="col-12 mt-3">
                <div class="row">
                    ...
                    <div class="col-4 mt-2">
                        ...
                        if ($user_data["status"] == 1 && ($selected_data['status'] == 1)) {
                        ?>
                            ...
                            <div class="row">
                                <div class="row input-lg">
                                    ...
                                    <button id="pb<?php echo $user_data['id']; ?>" class="btn btn-success" onclick="changeBalanseStatus('<?php echo $user_data['id']; ?>');">order</button>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        } else if ($user_data["status"] == 1 || ($selected_data['status'] == 2)) {
                        ...
                        } else if ($user_data["status"] == 2 || ($selected_data['status'] == 1)) {
    ...
    ?>
        ...
        <h1 class="fw-bold fs-1 text-center text-primary text-bg-dark start-50">Stay a While</h1>
<?php
